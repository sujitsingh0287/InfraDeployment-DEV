...
resource_groups = {
  rg1 = {
    name       = "blackberryv2-rg"
    location   = "westus"
    managed_by = "sujit"
    tags = {
      environment = "dev"
      project     = "blackberrydevteam"
      owner       = "sujit"
      phase       = "initial"
    }
  }
...
subnets = {
  frontend = {
    subnet_name          = "blkberry-frontend-subnet01"
    rg_key               = "rg1"
    virtual_network_name = "vnet1"
    address_prefixes     = ["10.10.1.0/24"]
  }
  backend = {
    subnet_name          = "blkberry-backend-subnet02"
    rg_key               = "rg1"
    virtual_network_name = "vnet1"
